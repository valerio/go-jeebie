...
func GetIntegrationTests() []IntegrationTestCase {
	...
	tests := []IntegrationTestCase{
		...
		{
			ROMPath:   "../../test-roms/game-boy-test-roms/blargg/dmg_sound/rom_singles/01-registers.gb",
			MaxFrames: 60,
			Name:      "dmg_sound_01-registers",
		},
		{
			ROMPath:   "../../test-roms/game-boy-test-roms/blargg/dmg_sound/rom_singles/02-len ctr.gb",
			MaxFrames: 600,
